...
) AS membername, f.name AS courtname
FROM Members AS m
RIGHT JOIN Bookings AS b ON m.memid = b.memid
...
AS membername,
CONCAT( m1.firstName, ' ', m1.surname )
AS recommendername
...
/* Q13: Find the facilities usage by month, but not guests */SELECT 
